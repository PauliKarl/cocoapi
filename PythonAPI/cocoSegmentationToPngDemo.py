...
def cocoSegmentationToPngDemo(dataDir='/data2/pd/sdc/shipdet/v1/coco/', dataTypeAnn='train2017', dataTypeRes='examples', \
    ...
    # Define paths
    # annPath = '%s/annotations/instance_%s.json' % (dataDir, dataTypeAnn)
    # if isAnnotation:
    ...
    annPath = '/data2/pd/sdc/shipdet/v1/coco/annotations/shipdet_trainval_v1.json'
    pngFolder = '/data2/pd/sdc/shipdet/v1/coco/annotations/stuffthingmaps/train2017/'
